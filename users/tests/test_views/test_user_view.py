...
class UserViewTestCase(APITestCase):
    ...
    def setUpTestData(cls):
        cls.tested_class = UserView
        cls.target_database = 'master'
        cls.queryset = User.objects.all()
        cls.serializer = UserSerializer
        cls.url_for_list = reverse('user_list')
        cls.url_for_single = reverse('single_user', kwargs={'pk': 1, })
    ...
    def test_Should_SerializerClassIsUserSerializer(self):
    ...
    def test_When_PatchMethodForListUsers_Should_ErrorWithStatus405(self):
    ...
    def test_When_DeleteMethodForListUsers_Should_ErrorWithStatus405(self):
    ...
    def test_When_GetMethodForListUsers_Should_ReturnDataWithStatus200(
            self):
        ...
        expected_data = {
            ...
            'next': None,
            'previous': None,
            'results': ListUserSerializer(self.queryset, many=True).data,
        }
    ...
    def test_When_PostMethodForListUsers_Should_ReturnDataWithStatus201(
            self):
        data = self.data
        ...
        real_data = response.data
        real_data['photo'] = real_data['photo'][17:]

        self.assertEqual(expected_status, real_status)
        self.assertEqual(expected_data, real_data)

    def test_When_PostMethodForSingleUser_Should_ReturnDataWithStatus200(
            self):
    ...
    def test_When_GetMethodForSingleUser_Should_ReturnDataWithStatus200(
            self):
    ...
    def test_When_PutMethodForSingleUser_Should_ReturnDataWithStatus200(
            self):
        data = self.data
    ...
    def test_When_PatchMethodForSingleUser_Should_ReturnDataWithStatus200(
            self):
        data = self.data
    ...
    def test_When_DeleteMethodForSingleUser_Should_ReturnDataWithStatus200(
            self):
