...
class UserAttemptRefreshViewTestCase(APITestCase):
    databases = {'master', }

    @classmethod
    def setUpTestData(cls):
        cls.tested_class = UserAttemptRefreshView
        cls.serializer = UserAttemptRefreshSerializer
        cls.tested_url = reverse('user_attempt_refresh',
    ...
    def test_Should_SerializerClassIsUserAttemptRefreshSerializer(self):
    ...
    def test_When_PostMethod_Should_RefreshUserAttempt(self):
        data = {
