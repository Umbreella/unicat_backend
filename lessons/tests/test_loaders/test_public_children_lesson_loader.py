...
from ...loaders.PublicChildrenLessonLoader import (
    PublicChildrenLessonLoader, public_children_lesson_loader)
from ...models.Lesson import Lesson
from ...models.LessonTypeChoices import LessonTypeChoices


class PublicChildrenLessonLoaderTestCase(TestCase):
    databases = {'master', }

    @classmethod
    def setUpTestData(cls):
        cls.tested_class = PublicChildrenLessonLoader
        cls.batch_load_fn = public_children_lesson_loader
